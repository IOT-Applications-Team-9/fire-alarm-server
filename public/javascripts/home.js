...
function updateData(tempChart, humiChart, fireChart, gasChart){
    ...
    const deviceId = + document.querySelector('.content-left-user-info span').innerHTML
    ...
    xhttp.onreadystatechange = function(){
        if(this.readyState == 4 && this.status == 200){
            ...
            if(res.latestStateList.length > 0){
                ...
                console.log(res.latestStateList[0])
    ...
    xhttp.open('GET', `/user/${userId}/updateData?deviceId=${deviceId}`, true)
    xhttp.send()
}
